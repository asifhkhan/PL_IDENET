...
import utils.common_pcnet as common
import numpy as np
from scipy import ndimage
import torch.nn.functional as F
import utils.utils_pcnet as utils
...
class KernelEstimate(nn.Module):
    def __init__(self, act_mode='R'):
        super(KernelEstimate, self).__init__()

        self.m_head = common.conv(3, 64, bias=True, mode='C'+ act_mode)

        self.m_body = common.sequential(
            *[common.ResBlock(64, 64, bias=True, mode='C' + act_mode + 'C') for _ in range(14)])

        self.m_tail = common.conv(64, 1, bias=True, mode='KaS')
