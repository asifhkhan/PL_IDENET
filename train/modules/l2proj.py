...
#
# time_total_l2proj = OrderedDict()
# time_total_l2proj['time'] = []
...
class L2Proj(nn.Module):
    ...
    def forward(self, x, stdn, alpha):
        ...
        # end_time = t.toc()
        # time_total_l2proj['time'].append(end_time)
        # print("Model_l2proj_forward_per_iter:", end_time)
        # if len(time_total_l2proj['time']) / 150 == 1:
        #     avg_time = sum(time_total_l2proj['time']) / len(time_total_l2proj['time'])
        #     print("avg_time_model_l2proj_epoch_1:", avg_time)
        return result
